...
$(function() {
	...
	var sources = {
		...
		"Bing Maps": "http://ecn.t0.tiles.virtualearth.net/tiles/r{quad}.jpeg?g=129&mkt=zh&stl=H",
		"Bing Maps Satellite": "http://ecn.t0.tiles.virtualearth.net/tiles/a{quad}.jpeg?g=129&mkt=zh-CN&stl=H",
		"Bing Maps Hybrid": "http://ecn.t0.tiles.virtualearth.net/tiles/h{quad}.jpeg?g=129&mkt=zh-CN&stl=H",
		...
		"Google Maps Roads CN": "https://mts1.google.com/vt/lyrs=h&gl=CN&hl=zh-CN&x={x}&y={y}&z={z}",
		...
		"Stamen Toner B&W": "http://a.tile.stamen.com/toner/{z}/{x}/{y}.png",
       	// "baidu": "http://maponline1.bdimg.com/tile/?qt=vtile&x={x}&y={y}&z={z}&styles=pl&scaler=1&udt=20200602&from=jsapi2_0",

		// "tian": "http://t1.tianditu.com/vec_c/wmts?layer=vec&style=default&tilematrixset=c&Service=WMTS&Request=GetTile&Version=1.0.0&Format=tiles&TileMatrix={z}&TileCol={x}&TileRow={y}&tk=433a6d003df7e0dc336c699d60f1f0ea",
		"gaode": "http://wprd04.is.autonavi.com/appmaptile?x={x}&y={y}&z={z}&lang=zh_cn&size=1&scl=1&style=7"
	...
	function initializeMap() {
		...
		map = new mapboxgl.Map({
			...
			center: [121.598348, 31.201189], // center默认是Y座
			zoom: 15
		});
	...
	function initializeMoreOptions() {
		...
		$("#output-type").change(function() {
			...
			if(outputType == "mbtiles(SQLite)") {
				outputFileBox.val("tiles.mbtiles")
			} else if(outputType == "repo(SQLite)") {
				outputFileBox.val("tiles.repo")
			} else if(outputType == "directory(文件)") {
				outputFileBox.val("{657}/{x}/{y}.png")
			}
		})
